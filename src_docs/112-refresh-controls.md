...
**When to use it:** When you've changed parameters on multiple fills and want to see the complete, up-to-date rendering. Also use it before exporting: you want to make sure the export reflects your current settings, not a stale render.
...
For deep dives into each of the twelve fill types, continue to Part 2. Or return to the [Table of Contents](001-toc.md) and pick any topic that interests you.
